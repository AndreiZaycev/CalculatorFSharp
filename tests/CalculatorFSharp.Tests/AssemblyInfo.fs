...
[<assembly: AssemblyTitleAttribute("CalculatorFSharp.Tests")>]
[<assembly: AssemblyProductAttribute("CalculatorFSharp")>]
...
module internal AssemblyVersionInformation =
    let [<Literal>] AssemblyTitle = "CalculatorFSharp.Tests"
    let [<Literal>] AssemblyProduct = "CalculatorFSharp"
